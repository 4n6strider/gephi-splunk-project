...
public class Edge2dModel extends EdgeModel {
    ...
    public void display(GL2 gl, GLU glu, VizModel vizModel) {
        ...
        Vec2f edgeVector2 = new Vec2f(x1-x2,y1-y2);
        edgeVector2.normalize();
        
        //Point of the arrow
        float targetX = x2 - edgeVector.x() * collisionDistance/1.3f;
        x2 = targetX;
        float targetY = y2 - edgeVector.y() * collisionDistance/1.3f;
        y2 = targetY;
        
        float collisionDistance2 = sourceModel.getCollisionDistance(angle2);
        
        float sourceX = x1 - edgeVector2.x() * collisionDistance2/1.3f;
        x1 = sourceX;
        float sourceY = y1 - edgeVector2.y() * collisionDistance2/1.3f;
        y1 = sourceY;
